            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Aplikasi absensi karyawan<br></p>
                  <p class="mb-0">Bagi yang belum memiliki username silahkan menghubungi IT Programmer</p>
                  <p class="mb-0">Ext  <b>5021 & 5023</b></p>
